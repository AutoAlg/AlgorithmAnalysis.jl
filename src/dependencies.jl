...
dependencies(::Zero)::Vector{ExpressionID} = []

dependencies(::ConcretelyValuedVariable)::Vector{ExpressionID} = []
...
dependencies(c::Constraint)::Vector{ExpressionID} = [c.expression]
